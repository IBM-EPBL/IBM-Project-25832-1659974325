...
src_path =r'D:\Documents\naalaiya thiran\2_Training\src'
print(src_path)
utils_path = r'D:\Documents\naalaiya thiran\Utils'
print(utils_path)
...
client = Cloudant.iam('9edde44c-8033-47db-aa9b-34ac18aeb5bf-bluemix','S9rghv50lMQJQ4Yky7EhY_XbkEEyf8IIzBBy34kd0rMK', connect=True)


# Create a database using an initialized client
my_database = client.create_database('jaisurya_skindisease')
